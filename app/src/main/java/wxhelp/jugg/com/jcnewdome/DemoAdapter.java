 ...
 * @Version: 1.0.0
 */
public class DemoAdapter extends BaseRecyclerViewAdapter<DemoAdapter.HolderView> {
    ...
    public DemoAdapter(List<String> data, Activity activity) {
        this.data = data;
    ...
    public HolderView createViewHolder_my(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(activity).inflate(R.layout.recyclerview_item, viewGroup, false);
